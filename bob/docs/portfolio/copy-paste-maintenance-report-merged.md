...
![Software change process applied to the Copy/Paste work](figures/software-change-process.svg)
...
![Runtime path from actions to transfer handler](figures/copy-paste-runtime-path.svg)
...
![Impact summary: many classes visited, few changed](figures/impact-summary.svg)
...
| Figure | Source file |
| --- | --- |
| Software change process | `bob/docs/portfolio/figures/software-change-process.svg` |
| Copy/Paste runtime path | `bob/docs/portfolio/figures/copy-paste-runtime-path.svg` |
| Impact summary | `bob/docs/portfolio/figures/impact-summary.svg` |
| Refactoring before/after | `bob/docs/portfolio/figures/refactoring-before-after.svg` |
| Postfactoring structure | `bob/docs/portfolio/figures/postfactoring-structure.svg` |
| BDD verification | `bob/docs/portfolio/figures/bdd-verification.svg` |
